...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-xl md:text-2xl text-neutral-600 mb-10 max-w-lg mx-auto md:mx-0 font-light">
              ...
              <p className="mt-6 text-sm text-neutral-500">
                <span className="font-bold text-neutral-900">10k+ cooks</span>{" "}
                joined last month.
              </p>
            </div>
            ...
            <Card
              className={
                "relative aspect-square md:aspect-4/5 border-4 border-neutral-900 bg-stone-200 overflow-hidden py-0"
              }
            >
              <Image
                src="/pasta-dish.png"
              ...
              <Card className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm border-2 border-neutral-900 py-0">
                <CardContent className="p-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <Badge
                      variant="outline"
                      className="border-2 border-green-700 bg-green-50 text-green-700 font-bold mt-2 "
                    >
                      98% MATCH
                    </Badge>
                  </div>
      ...
      <section className="py-12 border-y-2 border-neutral-900 bg-stone-900">
        <div className="max-w-5xl mx-auto grid grid-cols-2 gap-8 text-center md:grid-cols-4 px-4">
          {SITE_STATS.map((site, i) => (
            <div key={i}>
                ...
                >
                  <CardContent className={"p-8"}>
                    <div className="flex justify-between items-start mb-6">
                      <div className="border-2 border-stone-200 bg-orange-50 rounded-md p-3 group-hover:border-orange-600 group-hover:bg-orange-100 transition-colors">
                      ...
                      <Badge
                        variant="secondary"
                        className={
                          "text-xs font-mono bg-stone-100 text-neutral-600 uppercase tracking-wide border border-stone-200"
                        }
                      >
                        {feature.limit}
                      </Badge>
      ...
      <section className="py-24 px-4 border-y-2 border-neutral-200 bg-stone-900 text-stone-100">
