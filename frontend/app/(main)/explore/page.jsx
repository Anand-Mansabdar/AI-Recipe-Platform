            ...
            >
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="relative aspect-4/3 md:aspect-auto border border-b-2 md:border-b-0 md:border-r-2 border-stone-900">
                    <Image
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center ">
                    ...
                    <p className="text-stone-600 mb-6 line-clamp-6 font-light text-lg">
            ...
            {areas.map((area) => (
              <Link
                ...
                href={`/recipes/cuisine/${area.strArea
                  ...
                  .replace(/\s+/g, "-")}`}
              >
                <div className="bg-white p-5 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all text-center group cursor-pointer">
                  <div className="flex items-center">
                    <span className="text-3xl">
                      {getCountryFlag(area.strArea)}
                    </span>
                    <span className="font-bold text-stone-900 group-hover:text-orange-500 transition-colors text-sm">
                      {area.strArea}
                    </span>
                  </div>
                </div>
