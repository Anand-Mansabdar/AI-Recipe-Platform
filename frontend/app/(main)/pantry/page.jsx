    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-stone-600 font-light mt-2">
                  Manage your ingredients and disacover what you can cook
                </p>
              </div>
            </div>
            ...
            <Button
              ...
              className={"hidden md:flex hover:bg-orange-600 bg-orange-500"}
              size="lg"
            >
          ...
          {itemsData?.scansLimit !== undefined && (
            <div className="bg-white py-3 px-4 border-2 border-stone-200 inline-flex items-center gap-3 rounded-md">
      ...
      {items.length > 0 && (
        <Link href={`/pantry/recipes`} className="block mb-8">
          <div className="bg-linear-to-r from-green-600 to-emerald-500 text-white p-6 border-2 border-emerald-700 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group">
      ...
      {!loadingItems && items.length > 0 && (
        <div className="">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {items.map((item) => (
              <div
                className="bg-white p-5 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all"
                key={item.documentId}
              >
